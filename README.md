...
- écrans minimaux Next.js et Expo.

Le moteur NGAP, l’OCR et les appels LLM ne sont volontairement pas implémentés avant leurs
sprints dédiés et leur validation métier.
